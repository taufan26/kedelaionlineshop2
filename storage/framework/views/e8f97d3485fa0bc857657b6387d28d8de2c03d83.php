<div class="well well-small"><a id="myCart" href="product_summary.html"><img src="<?php echo e(asset('bootshop/themes/images/ico-cart.png')); ?>" alt="cart"><?php echo e(count(Cart::content())); ?> Items in your cart  <span class="badge badge-warning pull-right">Rp. <?php echo e(Cart::total()); ?></span></a></div>
