...
<div id="welcomeLine" class="row">
	...
	<div class="pull-right">
		<a href="<?php echo e(url('shopping-cart')); ?>"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> [ <?php echo e(count(Cart::content())); ?> ] Items in your cart </span> </a> 
	</div>
	</div>
</div>
<!-- Navbar ================================================== -->
				...
				<li class="span3">
			  	...
			  	?>
					...
					<div class="caption">
					  ...
					  <h4><a class="btn" href="<?php echo e(url('barang/show/'.$barang->barang_id)); ?>">VIEW</a> <span class="pull-right">Rp. <?php echo e(number_format($barang->harga, 0)); ?></span></h4>
					</div>
				  </div>
				</li>
			  ...
			  <ul class="thumbnails">
				...
				<li class="span3">
			  	...
			  	?>
					...
					<div class="caption">
					  <h5><?php echo e($barang->nama); ?></h5>
					  <h4><a class="btn" href="<?php echo e(url('barang/show/'.$barang->barang_id)); ?>">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
				  </div>
				</li>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
