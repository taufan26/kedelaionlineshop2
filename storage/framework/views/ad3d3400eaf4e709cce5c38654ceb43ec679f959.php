<div class="well well-small"><a id="myCart" href="/shopping-cart"><img src="<?php echo e(asset('bootshop/themes/images/ico-cart.png')); ?>" alt="cart"><?php echo e(count(Cart::content())); ?> Items in your cart  <span class="badge badge-warning pull-right">Rp. <?php echo e(Cart::subtotal()); ?></span></a></div>
