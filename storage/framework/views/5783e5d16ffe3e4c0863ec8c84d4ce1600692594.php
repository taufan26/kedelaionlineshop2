...
<div class="box box-primary">
    <!-- /.box-header -->
    <!-- form start -->
    <form role="form" method="POST" action="<?php echo e(url('barang/store')); ?>" enctype="multipart/form-data">
    	<?php echo e(csrf_field()); ?>

      <div class="box-body">
        <div class="form-group">
          <label for="exampleInputEmail1">Nama Barang</label>
          <input type="text" name="nama" value="<?php echo e(old('nama')); ?>" class="form-control" id="exampleInputEmail1">
        ...
        <div class="form-group">
          ...
          <textarea name="keterangan" class="form-control" id="editor1" rows="10"><?php echo e(old('keterangan')); ?></textarea>
        ...
        <div class="form-group">
          ...
          <select class="form-control select2" name="kategori_id">
          	...
          	<option value="<?php echo e($kategori->kategori_id); ?>"><?php echo e($kategori->nama); ?></option>
        ...
        <div class="form-group">
          ...
          <input type="number" name="harga" value="<?php echo e(old('harga')); ?>" class="form-control">
