            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="example1">
                ...
                <tr>
                  ...
                  <td><a style="color: blue;" href="<?php echo e(url('konfirmasi/terima/'.$konfirmasi->pesanan_id)); ?>">Terima</a> | <a style="color: red;" href="<?php echo e(url('konfirmasi/tolak/'.$konfirmasi->pesanan_id)); ?>">Tolak</a></td>
                </tr>
